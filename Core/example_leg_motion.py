...
while True:
    ...
    Lpa = np.array([[iXf + stepLength, -100, lspurWidth + frontSideStepLength, 1],
                    [iXf + stepLength, -100, -spurWidth + frontSideStepLength, 1],
                    [iXb + stepLength, -100, lspurWidth - backSideStepLength, 1],
                    [iXb + stepLength, -100, -spurWidth - backSideStepLength, 1]])

    Lpf = np.array([[iXf - stepLength, -100, spurWidth - frontSideStepLength, 1],
                    [iXf - stepLength, -100, -rspurWidth - frontSideStepLength, 1],
                    [iXb - stepLength, -100, spurWidth + backSideStepLength, 1],
                    [iXb - stepLength, -100, -rspurWidth + backSideStepLength, 1]])
